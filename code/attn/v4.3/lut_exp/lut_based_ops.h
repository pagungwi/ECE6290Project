...
__attribute__((always_inline)) v16accfloat getExpBf16(v16bfloat16 x) {
  ...
  //     (bfloat16 __aie_dm_resource_b *)exp_flut_cd;
    ...
    // update this will solove ????
  bfloat16 __aie_dm_resource_a *ilut_ab =
      (bfloat16 __aie_dm_resource_a *)exp_ilut_ab;

  bfloat16 __aie_dm_resource_b *ilut_cd =
      (bfloat16 __aie_dm_resource_b *)exp_ilut_ab;

  bfloat16 __aie_dm_resource_c *flut_ab =
      (bfloat16 __aie_dm_resource_c *)exp_flut_ab;

  bfloat16 __aie_dm_resource_d *flut_cd =
      (bfloat16 __aie_dm_resource_d *)exp_flut_ab;
  ...
  //v16bfloat16 aaa = v16bfloat16((v16int16)input);
  //exp_val = ups_to_v16accfloat(aaa);
  /*
2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38 2.35099e-38
   */

  exp_val = ups_to_v16accfloat(I_val_vec);
  /*
2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875 2.71875
   */

  //exp_val = ups_to_v16accfloat(F_val_vec);
