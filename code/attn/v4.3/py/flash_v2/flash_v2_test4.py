...
QQ_mat = torch.rand(1, 16, 1025, 64, dtype=torch.bfloat16)
KK_mat = torch.rand(1, 16, 1025, 64, dtype=torch.bfloat16)
VV_mat = torch.rand(1, 16, 1025, 64, dtype=torch.bfloat16)
OO_mat = torch.rand(1, 16, 1025, 64, dtype=torch.bfloat16)
...
save_bfloat16_tensor(Q1_mat, "16h_q.npy")
save_bfloat16_tensor(K1_mat, "16h_k.npy")
save_bfloat16_tensor(V1_mat, "16h_v.npy")
save_bfloat16_tensor(O1_mat, "16h_o.npy")
...
Q2_mat = load_bfloat16_tensor("16h_q.npy")

K2_mat = load_bfloat16_tensor("16h_k.npy")

V2_mat = load_bfloat16_tensor("16h_v.npy")

O2_mat = load_bfloat16_tensor("16h_o.npy")
